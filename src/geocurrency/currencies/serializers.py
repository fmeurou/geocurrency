...
class CurrencySerializer(serializers.Serializer):
    ...
    code = serializers.CharField(
        label="ISO-4217 code of the currency",
        read_only=True)
    name = serializers.CharField(
        label="Human readable name of the currency",
        read_only=True)
    currency_name = serializers.CharField(
        label="name of the currency",
        read_only=True)
    exponent = serializers.IntegerField(
        label="ISO-4217 exponent",
        read_only=True)
    number = serializers.IntegerField(
        label="ISO-4217 numeric identifier",
        read_only=True)
    value = serializers.CharField(
        read_only=True)
    symbol = serializers.SerializerMethodField(
        label="Symbol of the currency")
